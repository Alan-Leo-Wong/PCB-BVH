...
namespace bvh::v2 {
    ...
    struct Tri {
        ...
        BVH_ALWAYS_INLINE const Vec<T, N> &operator[](int index) const {
            switch (index) {
                case 0:
                    return p0;
                case 1:
                ...
                case 2:
                    return p2;
                default:
                    throw std::out_of_range("Index out of range. Valid range: [0, 2]");
            }
        }

        BVH_ALWAYS_INLINE Vec<T, N> &operator[](int index) {
            switch (index) {
                case 0:
                    return p0;
                case 1:
