...
//                    system("pause");
                ...
                /*if (right_id == 212) {
                    std::cout << std::boolalpha << "left_inter: " << left_inter << std::endl;
                    std::cout << std::boolalpha << "right_inter: " << right_inter << std::endl;
                    std::cout << std::boolalpha << "is_leaf: " << right.is_leaf() << std::endl;
                }*/
